...
import com.example.phattu.Auth.AuthenticationRequest;
import com.example.phattu.Sevices.JwtService;
import com.example.phattu.Sevices.PhatTuServices;
...
public class PhatTuController {
    ...
    @PutMapping(value = "/phattu",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = "/phattu",produces = MediaType.APPLICATION_JSON_VALUE)
